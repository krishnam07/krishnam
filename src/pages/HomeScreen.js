      ...
      >
        <View style={appStyles.card}>
          <Text style={appStyles.title}>
            One scan. One notification. One chance to help.
          </Text>
          <Text style={[appStyles.subtitle, { marginTop: 8, lineHeight: 18 }]}>
            With just one scan let people connect with you in real-life moments:
            wrong parking alerts, lost items, or emergency situations. Stay
            responsible. Keep humanity alive.
          </Text>
        ...
        <View style={appStyles.card}>
          <Text style={[appStyles.title, { fontSize: 17 }]}>
            Technology should solve real problems.
          </Text>
          <Text
            style={[
              appStyles.subtitle,
              { marginTop: 10, fontSize: 13, color: colors.text },
            ]}
          >
            Because sometimes...
          </Text>
          <Text style={[appStyles.title, { marginTop: 4, fontSize: 18 }]}>
            One scan is all it takes to help someone.
          </Text>
        </View>
      </ScrollView>
